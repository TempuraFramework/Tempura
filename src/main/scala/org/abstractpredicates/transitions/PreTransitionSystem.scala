...
class PreTransitionSystem {
  ...
  val fairnessAsssumptions: AccumulatingEntry[Core.Expr[Core.BoolSort]] = AccumulatingEntry[Core.Expr[Core.BoolSort]]("fairness-assumptions")
  ...
  def clear(): Unit =
    ...
    this.fairnessAsssumptions.reset()
  ...
  override def toString: String =
    ...
    b.append(fairnessAsssumptions).append("\n")

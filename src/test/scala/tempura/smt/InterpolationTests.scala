...
import SmtSolver.Result
import tempura.expression.Core
import tempura.smt.interpolants.{Cvc5Interpolation, InterpolationEngine, QEInterpolation, SmtInterpolInterpolation}
...
class InterpolationTests extends AnyFunSuite {
  ...
  test("simple interpolation test") {
    import tempura.expression.Syntax.intToNumber
